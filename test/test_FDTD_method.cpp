...
double run_test(Component test_field, SelectedFields current_fields, int Ni, int Nj, int Nk) {
    ...
    Parameters params_1{
        ...
        Nj,
        Nk,
		default_time / static_cast<double>(iters_1),
        0.0, 1.0, 0.0, 2.0, 0.0, 3.0,
        (1 - 0) / static_cast<double>(Ni),
        (2 - 0) / static_cast<double>(Nj),
        (3 - 0) / static_cast<double>(Nk)
    };
    FDTD_openmp::FDTD method_1(params_1);

    FDTD_openmp::Test_FDTD test_1(params_1);
    ...
    Parameters params_2{
        ...
        Nj * 2,
        Nk * 2,
		default_time / static_cast<double>(iters_2),
        0.0, 1.0, 0.0, 2.0, 0.0, 3.0,
        (1 - 0) / static_cast<double>(Ni * 2),
        (2 - 0) / static_cast<double>(Nj * 2),
        (3 - 0) / static_cast<double>(Nk * 2)
    };
    FDTD_openmp::FDTD method_2(params_2);

    FDTD_openmp::Test_FDTD test_2(params_2);
